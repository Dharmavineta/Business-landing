...
const IndProject = () => {
  return (
    <Container>
      <div className="mt-10 w-full text-black w-full ">
        ...
        <div className="flex flex-col gap-y-16 text-black px-10 mt-20">
          <div className="flex flex-col gap-y-6">
            ...
            <p className="text-sm text-slate-600">
              ...
              laboriosam quo quas facilis inventore nesciunt sed cupiditate
              magnam, ipsum autem aliquid vero quaerat quidem officiis commodi
              beatae cumque debitis sequi!
            </p>
          </div>
          <div className="flex flex-col gap-y-6">
          ...
          <div className="flex flex-col gap-y-6">
            ...
            <p className="text-sm text-slate-600">
              ...
              repellat doloribus adipisci aperiam distinctio suscipit quisquam?
              Nihil a aliquid natus quis error iure, unde velit cupiditate!
            </p>
          </div>
        </div>
        <div className="px-10 ">
